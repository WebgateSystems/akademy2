...
RSpec.describe 'API V1 Management Students', type: :request do
  ...
  describe 'GET /api/v1/management/students' do
    it 'returns 200' do
      allow(Api::V1::Management::ListStudents).to receive(:call).and_return(success_result)
      get '/api/v1/management/students', headers: headers
    ...
    it 'returns 403 when forbidden' do
      ...
      allow(Api::V1::Management::ListStudents).to receive(:call).and_return(result)
      get '/api/v1/management/students', headers: headers
